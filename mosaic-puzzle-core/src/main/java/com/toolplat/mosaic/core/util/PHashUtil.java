...
public class PHashUtil {
    public static void main(String[] args) {
        ...
        String hash = getFeatureValue("/Users/suyin/Documents/temp/target_rgb2.jpg");
    ...
    public static String getFeatureValue(BufferedImage bi) {
        // 缩小尺寸，简化色彩
        int[][] grayMatrix = getGrayPixel(bi, 128, 128);
        // 计算DCT
    ...
    public static int[][] getGrayPixel(BufferedImage bi, int width, int height) {
        try {
            bi = resizeImage(bi, width, height, BufferedImage.TYPE_INT_RGB);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
